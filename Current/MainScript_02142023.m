...
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed-noimport', 0.01, [])
...
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed-noimport', 0.1, [])
...
%{
celllines = ["NTC", "MDA231"];
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\EEA1 Comp1\']; root = 'EEA1Comp1'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.00, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\Tom20 Comp1\']; root = 'Tom20Comp1'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.10, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\SCA Comp1\']; root = 'SCAComp1'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.20, [])
%}

%{
celllines = ["NTC", "AU565", "MCF10A", "MDA231", "MDA436", "MDA468", "T47D"];
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\EEA1 Comp2\']; root = 'EEA1Comp2'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.30, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\Tom20 Comp2\']; root = 'Tom20Comp2'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.40, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\SCA Comp2\']; root = 'SCAComp2'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.50, [])
%}

%{
celllines = ["KD1", "AU565", "MCF10A", "MDA231", "MDA436", "MDA468", "T47D"];
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\EEA1 Comp3\']; root = 'EEA1Comp3'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.60, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\Tom20 Comp3\']; root = 'Tom20Comp3'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.70, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\SCA Comp3\']; root = 'SCAComp3'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.80, [])
%}
celllines = ["KD1", "MDA231"];
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\EEA1 Comp4\']; root = 'EEA1Comp4'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.60, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\Tom20 Comp4\']; root = 'Tom20Comp4'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.70, [])
dir = [script_dir '\Datasets\Fixed2D + Rab4A Comp\SCA Comp4\']; root = 'SCAComp4'; 
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'Fixed', 0.80, [])
...
function CompleteRFScript(celllines_color, celllines, dir, root, script_dir, specialcase, progress, tp, type)
    ...
    if (rf == 1)
        RandomForest_02142023(celllines_color, celllines, dir, root, progress); cd(script_dir);
    end
