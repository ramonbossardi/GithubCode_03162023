...
root = 'RandomForest_10172021_2D3CLOGMito';
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, '', 0)
...
%EECERC Inter:
dir = [script_dir '\Original 2D Datasets\2D 6CL\EECERC Interaction\'];
root = 'RandomForest_06262021_2D6CLEECERCInter';
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, ' ', 0.15)
%EECMito Inter:
dir = [script_dir '\Original 2D Datasets\2D 6CL\EECMito Interaction\'];
root = 'RandomForest_06262021_2D6CLEECMitoInter';
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, ' ', 0.20)
%ERCMito Inter:
dir = [script_dir '\Original 2D Datasets\2D 6CL\ERCMito Interaction\'];
root = 'RandomForest_06262021_2D6CLERCMitoInter';
...
function CompleteRFScript(celllines_color, celllines, dir, root, script_dir, specialcase, progress)
        ...
        IMARISDataImport_01112022_OGDataset(celllines_color, celllines, dir, root); cd(script_dir); 
