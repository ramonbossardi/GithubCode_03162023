function RandomForest_10132021_ROCFix(celllines_color, celllines, dir, root)
...
figure('Name', 'Random Forest Alt ROC Curve 1', 'NumberTitle', ...
                'off', 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]);    
progressbar([], [], .45, 0, 0)
    cellline_altauc = cellline_altroc(X_labels, forestCVClass, forestCVScore, 'ROC ~ All Param');
...
function auc_data = cellline_altroc(X_labels, forestCVClass, forestCVScore, fig_title) 
    t = tiledlayout('flow','TileSpacing','compact');
    nexttile
    hold on
