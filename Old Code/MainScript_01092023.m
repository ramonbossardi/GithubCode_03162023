...
dir = [script_dir '\Datasets\Live2D 5CL\ERCMitoInt 5CL ko+wt\']; root = 'Live2D5CL-ERCMitoInt';
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'tp-nonpool', 0.36, [])

root = 'Live2D5CL-ERCMitoInt';
CompleteRFScript(celllines_color, celllines, dir, root, script_dir, 'tp-nonpool', 0.36, [])
