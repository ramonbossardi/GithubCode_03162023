function IMARISDataImport_01152023_LiveNontrack_AllTP(celllines_color, celllines, maindir, root, pool)
    ...
    progressbar([], [], .4, 0, 0)
    [X, dpg_data] = parameter_calc(X, T_labels);
    ...
    function [X_new, mmdist_data] = parameter_calc(X, T_labels)
